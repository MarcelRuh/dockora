...
> Status: **v2.0.21** – self-hosted Docker management with in-app updates and GHCR images.
...
```bash
wget -qO- https://raw.githubusercontent.com/MarcelRuh/dockora/main/scripts/install.sh | DOCKORA_USE_IMAGES=1 DOCKORA_IMAGE_TAG=2.0.21 bash
```
